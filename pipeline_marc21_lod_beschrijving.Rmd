...
Het experiment is geslaagd omdat het gelukt is van 50 pamfletten Linked Open Data te maken. Alle geselecteerde metadata zijn vanuit MARC omgezet naar het Linked Open Data format, daarbij gebruik makend van veel gebruikte vocabularies. Hierdoor zijn de pamfletten op een extra manier ontsloten, beter vindbaar en bevraagbaar, en te koppelen aan andere datasets en collecties - ook als er geen VIAF of andere links zijn toegevoegd. Tevens wordt de koppeling met onze Worldcat Discovery omgeving behouden, waardoor de provenance gewaarborgd is. Er is vanuit de LOD-versie altijd terug te 'klikken' naar het oorspronkelijke pamflet in Worldcat. Hoewel de pipeline uit meerdere stappen bestaat is de omzetting van MARC naar LOD technisch niet heel complex.

Om de vindbaarheid en verbondenheid verder te stimuleren zijn er VIAF links toegevoegd. Via MarcEdit en Openrefine zijn in totaal 62 VIAF links toegevoegd (auteur en onderwerp) aan 31 pamfletten. Het bleek mogelijk om 27 hiervan automatisch te koppelen aan Wikidata en zo van 20 auteurs automatisch een afbeelding en geboortedatum op te halen. 

Het grootste obstakel is de kwaliteit van de metadata. Kwalitatief goede metadata en het hanteren van, moderne, standaarden zijn een vereiste voor het succesvol converteren van de MARC-records naar LOD. Het catalogiseren in de UBU heeft een lange geschiedenis. Veranderingen in regelgeving, gebruik van thesauri en conversies van oude naar nieuwe systemen hebben er toe geleid dat sommige metadata van mindere kwaliteit is dan andere. In dat geval is het lastig om VIAF of andere links toe te voegen, waarmee de mogelijkheden van Linked Data niet optimaal benut worden. Koppeling met externe data is geen vereiste, maar maakt het veel makkelijker om gevonden te worden, links te maken met andere collecties en de metadata te contextualiseren. Ook de taal van catalogiseren maakt uit, waarbij Engelse items overwegend eenvoudiger zijn te linken. Voor wat de handmatige invoer en opwaardering van records betreft, moeten de eisen die aan minimale metadata worden gesteld mogelijk worden herzien. Om LOD te realiseren is goede entity management - zoals thesaureren steeds meer wordt genoemd - een voorwaarde. 
...
- UBU Linked Data omgeving/ Triplestore creëren om verder te experimenteren en de resultaten toegankelijk te maken voor collega's. Een [triplestore](https://www.ontotext.com/knowledgehub/fundamentals/what-is-rdf-triplestore/) ontsluit de LOD online. Enkel in dit soort omgevingen is het mogelijk om het LOD datamodel verder te fine-tunen en via SPARQL of API's onze LOD te verbinden aan andere collecties.
- VIAF links gebruiken als validatie. Door het ophalen van externe data is in de LOD omgeving relatief eenvoudig te controleren of de toegevoegde VIAF (of Wikidata) links correct zijn (OCLC werkt aan een vergelijkbare methode voor meer moderne collecties en auteurs).
